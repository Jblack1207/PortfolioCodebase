...
const projects = [
  {
    ...
    // TODO: real repository URL.
    githubUrl: "https://github.com/Jblack1207/REPLACE-black-country-beats",
    liveUrl: null,
    imageUrl: null,
    featured: false,
    displayOrder: 0,
  },
  {
    ...
    category: "Mobile Application",
    // TODO: real repository URLs. githubUrl = "Backend & IoT",
    // liveUrl = "Mobile app" (see repoLabels in caseStudyContent.ts).
    githubUrl: "https://github.com/Jblack1207/REPLACE-healthguard-pro-backend",
    liveUrl: "https://github.com/Jblack1207/REPLACE-healthguard-pro-app",
    imageUrl: null,
    featured: false,
    displayOrder: 1,
  },
