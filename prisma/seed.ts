...
const projects = [
  {
    ...
    githubUrl: "https://github.com/Jblack1207/BlackCountryBeatsFlutterCodebase",
    liveUrl: null,
    imageUrl: null,
    featured: false,
    displayOrder: 0,
  },
  {
    ...
    category: "Mobile Application",
    // Two repositories: githubUrl is "Backend & IoT", liveUrl is "Mobile app".
    // See repoLabels in caseStudyContent.ts.
    githubUrl: "https://github.com/Jblack1207/HealthGuardPro_API",
    liveUrl: "https://github.com/Jblack1207/HealthGuardProFlutterCodebase",
    imageUrl: null,
    featured: false,
    displayOrder: 1,
  },
